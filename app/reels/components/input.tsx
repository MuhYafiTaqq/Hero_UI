...
export default function Input({onImageChange}: {onImageChange: (image: string) => void}) {
  ...
  return (
    <div className="flex-1 flex flex-col gap-2 justify-center items-center">
      <div
        className={`relative h-80 w-65 md:w-110 md:h-150 rounded-3xl border-3 text-center dark:bg-white/30 ${
          isDragging
      ...
      >
        ...
        />
        <h6 className="text-black dark:text-white md:text-xl text-sm font-bold mb-1">
          {isDragging ? "Drop the file here" : "Drag or click to select a file"}
        </h6>
        <p className="text-black/50 dark:text-white/50 md:text-md text-xs">
